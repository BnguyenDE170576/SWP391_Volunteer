                                        ...
                                        <%@include file="./components/footer.jsp" %>
                                            ...
                                            <div class="modal fade" id="editModal" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editModalLabel">Edit Activity
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea id="description" name="description"
                                                                    class="form-control"
                                                                    value="${detail.description}"></textarea>
                                                            </div>
                                                            ...
                                                            <form id="reportForm">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="reason"
                                                                        name="reason">
                                                                        <option value="reason1">Hoạt động này không đúng
                                                                            như những gì đã mô tả</option>
                                                                        <option value="reason2">Hoạt động này không phù
                                                                            hợp với tổ chức tình nguyện</option>
                                                                        <option value="reason3">Hoạt động này mang ý

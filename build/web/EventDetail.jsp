    ...
    <%@page import="java.text.SimpleDateFormat" %>
        ...
        <style>
            ...
            .options-menu {
                position: absolute;
                top: 0px;
                right: 20px; /* Điều chỉnh khoảng cách từ phía phải */
            }

            .ellipsis-icon {
                cursor: pointer;
                font-size: 24px; /* Tùy chỉnh kích thước biểu tượng */
                color: #333;
            }
            ...
            .options a {
                ...
                transition: background-color 0.3s; /* Hiệu ứng khi di chuột qua */
            }
                                ...
                                <div class="ps-lg-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <dd class="col-8">${detail.numberMember}</dd
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <dd class="col-8"> ${detail.location}</dd>
                                                                    <dt class="col-4">Số Lượng Thành Viên:</dt>
                                                                    <dd class="col-8">${detail.numberMember}</dd </div>
                                                                    <hr />
                                                                    <div class="text-center mt-4">
                                                                        <div class="grouptbt"
                                                                            ...
                                                                            <c:if
                                                                                test="${detail.organizerId != userID && check==0}">
                                                                            ...
                                                                            <c:if
                                                                                ...
                                                                                <form action="PendingUser"
                                                                                    ...
                                                                                    <input type="hidden" name="userID"
                                                                                        value="${userID}">
                                                                                    <button
                                                                                        class="btn btn-primary btn-lg">Tham
                                                                                        gia</button>
                                                                                </form>
                                                                            </c:if>
                                                                            <c:if
                                                                                test="${detail.organizerId != userID && check==1}">
                                                                                <box class="btn btn-primary btn-lg">Đợi
                                                                                    xét duyệt</box>
                                                                            </c:if>
                                                                            <c:if
                                                                                test="${detail.organizerId != userID && check==2}">
                                                                                <box class="btn btn-primary btn-lg">Đã
                                                                                    Tham gia</box>
                                                                            </c:if>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <%@include file="./components/footer.jsp" %>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <ul class="list-group">
                                                            <c:forEach var="us" items="${pendinglist}"
                                                                varStatus="status">
                                                                <li
                                                                    ...
                                                                    <div class="btn-group" role="group">
                                                                        <button style="margin-right: 10px;"
                                                                            ...
                                                                            onclick="rejectMember(${us.getId()}, ${detail.activityId}, this, this.nextElementSibling)">Từ
                                                                            chối</button>
                                                                        <button class="btn btn-success rounded-pill"
                                                                            onclick="approveMember(${us.getId()}, ${detail.activityId}, this, this.previousElementSibling)">Xét
                                                                            duyệt</button>
                                                                    </div>
                                                                </li>
                                                            </c:forEach>
                                        ...
                                        <c:if test="${detail.organizerId != userID && check==0}">
                                            <button id="approveButton" class="btn btn-primary btn-lg"
                                                data-toggle="modal" name="report"
                                                data-target="#reportModal">Report</button>
                                        </c:if>
                                        ...
                                        <c:if test="${detail.organizerId == userID}">
                                            <button id="editButton" class="btn btn-primary btn-lg" data-toggle="modal"
                                                data-target="#editModal">Edit</button>
                                        </c:if>
                                        <c:if test="${detail.organizerId != userID && check==0}">
                                            ...
                                            <div class="options-menu">
                                                ...
                                                <div class="options">
                                                    ...
                                                    <c:if test="${detail.organizerId == userID || sessionScope.LOGIN_USER.role  == 0}">
                                                        <a href="DeleteActivityControl?id=${detail.activityId}">Xoá</a>
                                                    </c:if>
                                                    <a href="#">Tố cáo</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${donateThu}" var="a" varStatus="loop">
                                    <tr>
                                        <td>${loop.index + 1}</td>                                
                                        <td>${a.tenNguoiGui}</td>
                                        <td>${a.nguoiNhan}</td>
        ...
        <div class="modal fade" id="chiModal">
            <div class="modal-dialog" style="max-width: 50%;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <input type="hidden" id="hoatdongnhan" name="hoatdongnhan" class="form-control" value="${detail.activityId}">
                        </div>
                        <div class="mb-3">
                            <label for="NDCK">Nội dung:</label>
                            <input type="text" id="NDCK" name="NDCK" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label for="money">Số tiền:</label>
                            <input type="number" id="money" name="money" class="form-control" min="1" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Đóng</button>
            ...
            <div class="modal-dialog" style="max-width: 50%;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <textarea id="description" name="description" class="form-control" value="${detail.description}">${detail.description}</textarea>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${status == 'Đang diễn ra'}">
                                                                    <div class="mb-3">
                                                                        <label for="endDateStr">End Date:</label>
                                                                        <input type="date" id="endDateStr"
                                                                            name="endDateStr" class="form-control"
                                                                            required>
                                                                        <input type="hidden" name="startDateStr"
                                                                            id="startDateStr" class="form-control"
                                                                            value="${detail.startDate}">
                        ...
                        <div class="mb-3">
                            <label for="memberLimit">Member Limit:</label>
                            <input type="number" id="memberLimit" name="memberLimit" class="form-control" min="1" required  value="${detail.numberMember}">
                        </div>
                ...
                if (!optionsMenu.contains(event.target)) {
                    optionsList.style.display = 'none';
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="ReportNotification" method="post"
                                                                id="reportForm">
                                                                <input type="hidden" name="activityId"
                                                                    value="${detail.activityId}">

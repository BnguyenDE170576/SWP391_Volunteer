...
public final class EventDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("    <body>\r\n");
      out.write("        <!-- Nội dung trang web của bạn -->\r\n");
      out.write("\r\n");
      out.write("        <!-- Mã HTML và JavaScript modal -->\r\n");
      ...
      out.write("                        <ul>\r\n");
      out.write("                            <li>Thành viên 1 <button onclick=\"rejectMember(1)\">Từ chối</button> <button onclick=\"approveMember(1)\">Xét duyệt</button></li>\r\n");
      out.write("                            <li>Thành viên 2 <button onclick=\"rejectMember(2)\">Từ chối</button> <button onclick=\"approveMember(2)\">Xét duyệt</button></li>\r\n");
      out.write("                            <!-- Thêm danh sách thành viên và nút tại đây -->\r\n");
      out.write("                        </ul>\r\n");
      out.write("                    </div>\r\n");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                                <button class=\"btn btn-success btn-lg\">Donate</button>\r\n");
        out.write("                            </div>\r\n");
        out.write("                        </div>\r\n");
        out.write("                    </div>\r\n");
        out.write("                </div>\r\n");
